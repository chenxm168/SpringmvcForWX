...
public class MsgUtils {
	...
	private static Logger log = LogManager.getLogger(MsgUtils.class);

	/*
	 * public static String MakeXmlMessage() {
	 * 
	 ...
	 * 
	 * 
	 * public static String getQueryMsg(String queryname) { ClassPathResource
	 ...
	 * StringUtils.EMPTY; }
	 */
	public static String MakeToMesEventMessage(String xml) {
		return MakeToMesMessage(xml, "oic");

	}

	public static String MakeToMesQueryMessage(String xml) {
		return MakeToMesMessage(xml, "qry");

	}

	private static synchronized String MakeToMesMessage(String xml,
			String systemmodule) {
	...
	private static String MakeMessage(String msgfile, String msgName,
			Map<String, String> map) {

		try {
			ClassPathResource classPathResource = new ClassPathResource(msgfile);
	...
	public static String MakeMesMessage(String msgName, Map<String, String> map) {

		return MakeMessage("mesmsg.xml", msgName, map);

	}

	public static String MakeQueryMessage(String msgName,
			Map<String, String> map) {

		return MakeMessage("querymsg.xml", msgName, map);
	...
	public static Element getElement(String xml, String name) {
	...
	public static String getWXModule(String xml) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public static String getWXEnv(String xml) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public static String getWXUserEnv(String xml, String userid) {
	...
	public static String getWXUserId(String xml) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public static String getWXMsgName(String xml) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public static String getWXMsgServiceName(String xml) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public static Map<String, String> getWXParamMap(String xml) {
		Document doc;
	...
	public static String getMesMsgReturnCode(String xml) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public static String getWXQueryId(String xml) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public static String getWXQueryVer(String xml) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public  static synchronized String  getXmlElementText(String xml, String name) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public  static synchronized Element  getXmlElement(String xml, String name) {
		Document doc;
		try {
			doc = DocumentHelper.parseText(xml);
			Element root = doc.getRootElement();
	...
	public static String makeJsonMsgForQueryReplyMsg(String mesreply) {
	...
	public static String makeJsonMsgForEventReplyMsg(String mesreply) {
		String rtncodeString = getMesMsgReturnCode(mesreply);
		try {
			Document doc = DocumentHelper.parseText(mesreply);
			Element root = doc.getRootElement();
	...
	public static Document MakeBaseReturnMessageDoc() {
	...
	public static String  setSourceTarget(String xml,String source) {
		...
		try {
			...
			Element element = (Element) rtnroot.selectSingleNode("//ORIGINALSOURCESUBJECTNAME");
			if(element!=null)
			{
	...
	public synchronized static  List<String> getParamList(String xml) {
		ArrayList<String> arrayList = new ArrayList<String>();
		try {
			Document doc= DocumentHelper.parseText(xml);
			Element root=doc.getRootElement();
			Element element =(Element) root.selectSingleNode("//PARAMLIST | //ParamList |//paramlist");
			if(element!=null)
			{
	...
	public Document AttachWxPageSet(String xml,String pagename) {
		try {
			...
			Element setpage= (Element) setroot.selectSingleNode("//pages/page[@name='"+pagename+"']");
			
			Document mesdoc = DocumentHelper.parseText(xml);
			Element mesroot= mesdoc.getRootElement();
			Document rtndoc= DocumentHelper.createDocument();
			rtndoc.add((Element) mesroot.clone());
			Element rtnbody=(Element) rtndoc.getRootElement().selectSingleNode("//Body | //Body | //BODY");
			if(rtnbody!=null)
			{
